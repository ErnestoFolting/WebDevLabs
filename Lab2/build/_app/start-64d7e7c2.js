...
var X = (n, t, e) =>
	...
	E = (n, t) => {
		for (var e in t || (t = {})) M.call(t, e) && X(n, e, t[e]);
		if (C) for (var e of C(t)) Y.call(t, e) && X(n, e, t[e]);
		return n;
	},
	F = (n, t) => ot(n, lt(t));
var H = (n, t) => {
	...
	if (n != null && C) for (var s of C(n)) t.indexOf(s) < 0 && Y.call(n, s) && (e[s] = n[s]);
	return e;
};
import {
	S as ut,
...
function Q(n) {
	...
	function i(o) {
		...
		for (let u = 0; u < r.length; u += 1) l = z(l, r[u]);
		return { props: l };
	}
	return (
		a && (t = new a(i(n))),
		{
			...
			l(o) {
				t && D(t.$$.fragment, o), (e = y());
			},
			m(o, l) {
				t && q(t, o, l), k(o, e, l), (s = !0);
			},
			p(o, l) {
				const u = l & 4 ? B(r, [K(o[2] || {})]) : {};
				if ((l & 521 && (u.$$scope = { dirty: l, ctx: o }), a !== (a = o[0][1]))) {
					if (t) {
						T();
						const c = t;
						b(c.$$.fragment, 1, 0, () => {
					...
					a
						? ((t = new a(i(o))), L(t.$$.fragment), m(t.$$.fragment, 1), q(t, e.parentNode, e))
						: (t = null);
				} else a && t.$set(u);
			},
			i(o) {
		...
		a && (t = new a(i())),
		{
			...
			p(o, l) {
				...
				if (a !== (a = o[0][2])) {
					...
					a
						? ((t = new a(i())), L(t.$$.fragment), m(t.$$.fragment, 1), q(t, e.parentNode, e))
						: (t = null);
				} else a && t.$set(u);
			},
			i(o) {
...
function kt(n) {
	...
	return {
		...
		m(r, a) {
			s && s.m(r, a), k(r, t, a), (e = !0);
		},
		p(r, a) {
			r[0][2]
				? s
					? (s.p(r, a), a & 1 && m(s, 1))
					: ((s = Z(r)), s.c(), m(s, 1), s.m(t.parentNode, t))
				: s &&
				  (T(),
				  b(s, 1, 1, () => {
						s = null;
...
function x(n) {
	...
	return {
		...
		l(s) {
			...
			var r = _t(t);
			e && e.l(r), r.forEach(v), this.h();
		},
		h() {
			V(t, 'id', 'svelte-announcer'),
				V(t, 'aria-live', 'assertive'),
				V(t, 'aria-atomic', 'true'),
				V(t, 'class', 'svelte-1j55zn5');
		},
		m(s, r) {
			k(s, t, r), e && e.m(t, null);
		},
		p(s, r) {
...
function Rt(n) {
	...
	var i = n[0][0];
	function o(u) {
		let c = { $$slots: { default: [$t] }, $$scope: { ctx: u } };
		for (let f = 0; f < a.length; f += 1) c = z(c, a[f]);
		return { props: c };
	}
	i && (t = new i(o(n)));
	let l = n[4] && x(n);
	return {
		c() {
			t && L(t.$$.fragment), (e = wt()), l && l.c(), (s = y());
		},
		l(u) {
			t && D(t.$$.fragment, u), (e = yt(u)), l && l.l(u), (s = y());
		},
		m(u, c) {
			t && q(t, u, c), k(u, e, c), l && l.m(u, c), k(u, s, c), (r = !0);
		},
		p(u, [c]) {
			const f = c & 2 ? B(a, [K(u[1] || {})]) : {};
			if ((c & 525 && (f.$$scope = { dirty: c, ctx: u }), i !== (i = u[0][0]))) {
				if (t) {
					T();
					const h = t;
					b(h.$$.fragment, 1, 0, () => {
				...
				i
					? ((t = new i(o(u))), L(t.$$.fragment), m(t.$$.fragment, 1), q(t, e.parentNode, e))
					: (t = null);
			} else i && t.$set(f);
			u[4]
				? l
					? l.p(u, c)
					: ((l = x(u)), l.c(), l.m(s.parentNode, s))
				: l && (l.d(1), (l = null));
		},
		i(u) {
			r || (t && m(t.$$.fragment, u), (r = !0));
		},
		o(u) {
			t && b(t.$$.fragment, u), (r = !1);
		},
		d(u) {
			t && U(t, u), u && v(e), l && l.d(u), u && v(s);
		}
	};
}
function St(n, t, e) {
	...
	return (
		Et(() => {
			const h = s.page.subscribe(() => {
				u && (e(5, (c = !0)), e(6, (f = document.title || 'untitled page')));
			});
			return e(4, (u = !0)), h;
		}),
		(n.$$set = (h) => {
...
const qt = 'modulepreload',
	...
	w = [
		() =>
			I(
				() => import('./pages/__layout.svelte-e2314ec0.js'),
				[
					'pages/__layout.svelte-e2314ec0.js',
					'assets/pages/__layout.svelte-0192e190.css',
					'chunks/vendor-9696d423.js'
				]
			),
		() =>
			I(
				() => import('./error.svelte-89c8f168.js'),
				['error.svelte-89c8f168.js', 'chunks/vendor-9696d423.js']
			),
		() =>
			I(
				() => import('./pages/index.svelte-44e26e32.js'),
				[
					'pages/index.svelte-44e26e32.js',
					'assets/pages/index.svelte-7d95003e.css',
					'chunks/vendor-9696d423.js'
				]
			),
		() =>
			I(
				() => import('./pages/about.svelte-9cc40566.js'),
				[
					'pages/about.svelte-9cc40566.js',
		...
		() =>
			I(
				() => import('./pages/todos/index.svelte-10865084.js'),
				[
					'pages/todos/index.svelte-10865084.js',
...
class It {
	...
	init_listeners() {
		...
		addEventListener('scroll', () => {
			clearTimeout(t),
				(t = setTimeout(() => {
					const a = F(E({}, history.state || {}), { 'sveltekit:scroll': W() });
		...
		addEventListener('touchstart', e),
			...
			addEventListener('click', (a) => {
				...
				const l = (i.getAttribute('rel') || '').split(/\s+/);
				if (
				...
				history.pushState({}, '', o.href),
					this._navigate(o, u ? W() : null, !1, [], o.hash),
					a.preventDefault();
			}),
	...
	async goto(
		...
		return this.enabled && this.owns(o)
			? (history[s ? 'replaceState' : 'pushState'](a, '', t),
			  this._navigate(o, e ? W() : null, r, i, o.hash))
	...
	async _navigate(t, e, s, r, a) {
		...
		this.renderer.notify({ path: i.path, query: i.query }),
			await this.renderer.update(i, r, !1, { hash: a, scroll: e, keepfocus: s });
	}
}
function nt(n) {
...
function Vt(n, t) {
	...
	t && typeof t.body == 'string' && (s += `[data-body="${Nt(t.body)}"]`);
...
class Dt {
	constructor({ Root: t, fallback: e, target: s, session: r, host: a }) {
		(this.Root = t),
			...
			(this.stores = { page: Ct({}), navigating: J(null), session: J(r) }),
			(this.$session = null),
			(this.root = null);
		let i = !1;
	...
	async start({ status: t, error: e, nodes: s, page: r }) {
		...
		try {
			for (let u = 0; u < s.length; u += 1) {
				...
				if ((a.push(f), f && f.loaded))
					if (f.loaded.error) {
						...
						l = { status: f.loaded.status, error: f.loaded.error, path: r.path, query: r.query };
					} else f.loaded.stuff && (i = E(E({}, i), f.loaded.stuff));
			}
			o = l
			...
			if (e) throw u;
			o = await this._load_error({ status: 500, error: nt(u), path: r.path, query: r.query });
		}
		if (o.redirect) {
	...
	async update(t, e, s, r) {
		...
		if (
			...
			const { hash: l, scroll: u, keepfocus: c } = r;
			c || document.body.focus();
			const f = l && document.getElementById(l.slice(1));
			u ? scrollTo(u.x, u.y) : f ? f.scrollIntoView() : scrollTo(0, 0);
		}
		if (
			(await 0,
	...
	async _get_navigation_result(t, e) {
		...
		for (let s = 0; s < t.routes.length; s += 1) {
			const r = t.routes[s];
			if (r.length === 1) return { reload: !0, props: {}, state: this.current };
			let a = s + 1;
	...
	async _get_navigation_result_from_branch({ page: t, branch: e }) {
		...
		for (let l = 0; l < s.length; l += 1) {
			const u = s[l].loaded;
			a.props[`props_${l}`] = u ? await u.props : null;
		}
		(!this.current.page ||
		...
		if (o) {
			...
			const c = () => {
				...
				f = setTimeout(c, o * 1e3),
				h = this.stores.session.subscribe(() => {
					u && c();
				});
			(u = !0), this.cache.set(l, a);
		}
		return a;
	}
	async _load_node({ status: t, error: e, module: s, page: r, stuff: a }) {
		...
		for (const u in r.params)
			Object.defineProperty(o, u, {
				get() {
					return i.uses.params.add(u), r.params[u];
				},
				enumerable: !0
			});
		...
		if (s.load) {
			const { started: u } = this,
				c = {
					...
					get stuff() {
						return (i.uses.stuff = !0), E({}, a);
					},
					fetch(h, R) {
						const $ = typeof h == 'string' ? h : h.url,
							{ href: A } = new URL($, new URL(r.path, document.baseURI));
						return i.uses.dependencies.push(A), u ? fetch(h, R) : Vt(h, R);
					}
				};
			e && ((c.status = t), (c.error = e));
			const f = await s.load.call(null, c);
			if (!f) return;
			(i.loaded = Ot(f)), i.loaded.stuff && (i.stuff = i.loaded.stuff);
		}
		return i;
	}
	async _load({ route: t, info: { path: e, decoded_path: s, query: r } }, a) {
		...
		const [o, l, u, c] = t,
			...
			R = { host: this.host, path: e, query: r, params: f };
		let $ = [],
			A = {},
			G = !1,
			N = 200,
		...
		t: for (let d = 0; d < l.length; d += 1) {
			...
			try {
				...
				if (
					...
					g !== p.module ||
					(h.path && p.uses.path) ||
					h.params.some((S) => p.uses.params.has(S)) ||
					(h.query && p.uses.query) ||
					(h.session && p.uses.session) ||
					p.uses.dependencies.some((S) => this.invalid.has(S)) ||
					(G && p.uses.stuff)
				) {
					_ = await this._load_node({ module: g, page: R, stuff: A });
					const S = d === l.length - 1;
					if (_ && _.loaded) {
						if (
							(_.loaded.error && ((N = _.loaded.status), (j = _.loaded.error)), _.loaded.redirect)
						)
							return { redirect: _.loaded.redirect, props: {}, state: this.current };
						_.loaded.stuff && (G = !0);
					} else if (S && g.load) return;
				} else _ = p;
			} catch (g) {
				(N = 500), (j = nt(g));
			}
					...
					if (u[d]) {
						...
						try {
							if (
								...
								continue;
							$ = $.slice(0, O + 1).concat(g);
							break t;
						} catch (S) {
							continue;
						}
					}
				return await this._load_error({ status: N, error: j, path: e, query: r });
			} else _ && _.loaded && _.loaded.stuff && (A = E(E({}, A), _.loaded.stuff)), $.push(_);
		}
		return await this._get_navigation_result_from_branch({ page: R, branch: $ });
	}
...
async function zt({
	...
	const l = new Dt({ Root: Lt, fallback: jt, target: t, session: e, host: s }),
		u = r ? new It({ base: n.base, routes: At, trailing_slash: i, renderer: l }) : null;
	Pt(n),
		o && (await l.start(o)),
		u && (a && u.goto(location.href, { replaceState: !0 }, []), u.init_listeners()),
