...
const metadata_lookup = {
	'src/routes/__layout.svelte': {
		entry: 'pages/__layout.svelte-e2314ec0.js',
		css: ['assets/pages/__layout.svelte-0192e190.css'],
		js: ['pages/__layout.svelte-e2314ec0.js', 'chunks/vendor-9696d423.js'],
		styles: []
	},
	'.svelte-kit/build/components/error.svelte': {
		entry: 'error.svelte-89c8f168.js',
		css: [],
		js: ['error.svelte-89c8f168.js', 'chunks/vendor-9696d423.js'],
		styles: []
	},
	'src/routes/index.svelte': {
		entry: 'pages/index.svelte-44e26e32.js',
		css: ['assets/pages/index.svelte-7d95003e.css'],
		js: ['pages/index.svelte-44e26e32.js', 'chunks/vendor-9696d423.js'],
		styles: []
	},
	'src/routes/about.svelte': {
		entry: 'pages/about.svelte-9cc40566.js',
		css: ['assets/pages/about.svelte-bf4528fa.css'],
		js: ['pages/about.svelte-9cc40566.js', 'chunks/vendor-9696d423.js'],
		styles: []
	},
	'src/routes/todos/index.svelte': {
		entry: 'pages/todos/index.svelte-10865084.js',
		css: ['assets/pages/todos/index.svelte-784042c1.css'],
		js: ['pages/todos/index.svelte-10865084.js', 'chunks/vendor-9696d423.js'],
		styles: []
	}
};
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	$$unsubscribe_page();
	return `<header class="${'svelte-t2wq17'}"><div class="${'corner svelte-t2wq17'}"><a href="${'https://kit.svelte.dev'}" class="${'svelte-t2wq17'}"><img${add_attribute(
		'src',
		logo,
		0
	)} alt="${'SvelteKit'}" class="${'svelte-t2wq17'}"></a></div>
	...
	<nav class="${'svelte-t2wq17'}"><svg viewBox="${'0 0 2 3'}" aria-hidden="${'true'}" class="${'svelte-t2wq17'}"><path d="${'M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z'}" class="${'svelte-t2wq17'}"></path></svg>
		<ul class="${'svelte-t2wq17'}"><li class="${['svelte-t2wq17', $page.path === '/' ? 'active' : '']
		.join(' ')
		.trim()}"><a sveltekit:prefetch href="${'/'}" class="${'svelte-t2wq17'}">Home</a></li>
			<li class="${['svelte-t2wq17', $page.path === '/about' ? 'active' : '']
				.join(' ')
				.trim()}"><a sveltekit:prefetch href="${'/about'}" class="${'svelte-t2wq17'}">About</a></li>
			<li class="${['svelte-t2wq17', $page.path === '/todos' ? 'active' : '']
				.join(' ')
				.trim()}"><a sveltekit:prefetch href="${'/todos'}" class="${'svelte-t2wq17'}">Todos</a></li></ul>
...
const Todos = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	let { todos } = $$props;
	if ($$props.todos === void 0 && $$bindings.todos && todos !== void 0) $$bindings.todos(todos);
	$$result.css.add(css);
...
<div class="${'todos svelte-dmxqmd'}"><h1>Todos</h1>
	...
	${each(
		todos,
		(todo) => `<div class="${['todo svelte-dmxqmd', todo.done ? 'done' : '']
			.join(' ')
			.trim()}"><form action="${
			...
			}" method="${'post'}"><button class="${'delete svelte-dmxqmd'}" aria-label="${'Delete todo'}" ${
